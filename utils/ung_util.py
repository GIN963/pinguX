...
shadow_fields = {
    "password_hash": {
        "index": 1,
        "empty_msg": "[FAIL] No password hash found → the account might not require a password (disabled or misconfigured)."
    },
    "last_changed": {
        "index": 2,
        "empty_msg": "[WARNING] Last password change date is empty → the system may not be tracking password changes."
    },
    "min_days": {
        "index": 3,
        "empty_msg": "[WARNING] Minimum days between password changes not set → users might change passwords too frequently."
    },
    "max_days": {
        "index": 4,
        "empty_msg": "[WARNING] Maximum days between password changes not set → passwords might never expire."
    },
    "warn_days": {
        "index": 5,
        "empty_msg": "[WARNING] Warning days before password expiration not set → users won’t be alerted before expiry."
    },
    "inactive_days": {
        "index": 6,
        "empty_msg": "[WARNING] Inactivity period after password expiration not set → expired accounts may stay active indefinitely."
    },
    "expire": {
        "index": 7,
        "empty_msg": "[WARNING] Account expiration date is empty → the account may never expire."
    }
}
